...
import ru.sharipov.helpers.FileSystemHelper;
import ru.sharipov.services.DbUserService;
import ru.sharipov.services.TemplateProcessor;
import ru.sharipov.servlet.UsersApiServlet;
import ru.sharipov.servlet.UsersServlet;
...
public class UsersWebServerSimple implements UsersWebServer {
    ...
    private final DbUserService userDao;
    private final Gson gson;
    protected final TemplateProcessor templateProcessor;
    private final Server server;

    public UsersWebServerSimple(int port, DbUserService userDao, Gson gson, TemplateProcessor templateProcessor) {
