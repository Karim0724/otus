...
import ru.sharipov.core.repository.executor.DbExecutorImpl;
import ru.sharipov.core.sessionmanager.TransactionRunnerJdbc;
import ru.sharipov.crm.datasource.DriverManagerDataSource;
import ru.sharipov.crm.model.Client;
import ru.sharipov.crm.model.Manager;
import ru.sharipov.crm.service.DbServiceClientImpl;
import ru.sharipov.crm.service.DbServiceManagerImpl;
import ru.sharipov.orm.*;
...
// Сделайте тоже самое с классом Manager (для него надо сделать свою таблицу)
        ...
        managerSecond.setParam1("ManagerSecondParam");
        managerSecond.setLabel("ManagerSecondLabelChanged");
        dbServiceManager.saveManager(managerSecond);
        log.info("Manager second changed:{}", managerSecond);
